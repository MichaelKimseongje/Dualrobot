...
class UR3Robotiq85(RobotBase):
    def __init_robot__(self):
        ...
        self.id = p.loadURDF('./urdf/ur3_2F85.urdf', self.base_pos, self.base_ori,
                             useFixedBase=True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
        
        # self.id = p.loadURDF('./urdf/ur3_robotiq_85.urdf', self.base_pos, self.base_ori,
        #                      useFixedBase=True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
...
class UR5Robotiq140(UR5Robotiq85):
    def __init_robot__(self):
        ...
        URDF = r'D:\Michael\2025\01.Research\01.Parceldetection\16.Pybullet\tutorial\urdf\ur_description\urdf\ur5_2F\urdf/'
        LEFT_URDF = URDF+"ur5_robotiq_140.urdf"
        self.id = p.loadURDF(LEFT_URDF, self.base_pos, self.base_ori,
                              useFixedBase=True, flags=p.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
